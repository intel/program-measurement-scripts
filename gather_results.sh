	...
	do
		...
		do
			...
			do
				...
				./draw_counters.sh "$res_file" "Memory" "" "L1D_REPLACEMENT L1D_WB_RQST_ALL L1D_WB_RQST_MISS SQ_MISC_FILL_DROPPED L2_LINES_IN_ALL L2_TRANS_L2_WB L3_LAT_CACHE_MISS CAS_COUNT_RD CAS_COUNT_WR"
