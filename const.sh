...
ACTIVATE_MEM_HIT_COUNTERS=1
if [ $HOSTNAME == "fxhaswell-server" ]; then
    ACTIVATE_MEM_ROWBUFF_COUNTERS=1
else
    ACTIVATE_MEM_ROWBUFF_COUNTERS=0
fi
ACTIVATE_RESOURCE_COUNTERS=${ACTIVATE_FOR_MLM}
...
ACTIVATE_TOPDOWN_COUNTERS=${ACTIVATE_FOR_MLM}
...
ACTIVATE_BRANCH_COUNTERS=1
ACTIVATE_LSD_COUNTERS=1
