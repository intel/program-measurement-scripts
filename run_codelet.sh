	...
	do
		...
		then
			...
			then
				...
				emon_counters="CYCLES_DIV_BUSY.ALL,UOPS_RETIRED.ALL,NO_ALLOC_CYCLES.ROB_FULL,NO_ALLOC_CYCLES.RAT_STALL,NO_ALLOC_CYCLES.NOT_DELIVERED,NO_ALLOC_CYCLES.ALL,RS_FULL_STALL.MEC,RS_FULL_STALL.ALL,INST_RETIRED.ANY_P,CPU_CLK_UNHALTED.CORE,CPU_CLK_UNHALTED.REF_TSC,LONGEST_LAT_CACHE.REFERENCE,LONGEST_LAT_CACHE.MISS,REHABQ.STA_FULL,REHABQ.ANY_LD,REHABQ.ANY_ST,MEM_UOPS_RETIRED.L1_MISS_LOADS,MEM_UOPS_RETIRED.L2_HIT_LOADS,MEM_UOPS_RETIRED.L2_MISS_LOADS,PAGE_WALKS.D_SIDE_WALKS,OFFCORE_RESPONSE:request=PF_L1_DATA_RD:response=ANY_RESPONSE,PAGE_WALKS.D_SIDE_CYCLES,OFFCORE_RESPONSE:request=COREWB:response=L2_MISS.NO_SNOOP_NEEDED,MS_DECODED.MS_ENTRY,OFFCORE_RESPONSE:request=COREWB:response=L2_HIT"
			fi
		fi
