...
then
    ...
    for i in $( seq $META_REPETITIONS )
      ...
      sq_counters="OFFCORE_REQUESTS_BUFFER.SQ_FULL,OFFCORE_REQUESTS_OUTSTANDING.ALL_DATA_RD,OFFCORE_REQUESTS_OUTSTANDING.DEMAND_RFO"
      lfb_histogram_counters="L1D_PEND_MISS.PENDING:c1,L1D_PEND_MISS.PENDING:c2,L1D_PEND_MISS.PENDING:c3,L1D_PEND_MISS.PENDING:c4,L1D_PEND_MISS.PENDING:c5,L1D_PEND_MISS.PENDING:c6,L1D_PEND_MISS.PENDING:c7,L1D_PEND_MISS.PENDING:c8,L1D_PEND_MISS.PENDING:c9,L1D_PEND_MISS.PENDING:c8,L1D_PEND_MISS.PENDING:c10,L1D_PEND_MISS.PENDING:c8,L1D_PEND_MISS.PENDING:c11"
      ...
      histogram_counters="${lfb_histogram_counters},${sqr_histogram_counters},${sqw_histogram_counters}"
