...
then
    ...
    for i in $( seq $META_REPETITIONS )
      ...
      sq_counters="OFFCORE_REQUESTS_BUFFER.SQ_FULL,OFFCORE_REQUESTS_OUTSTANDING.ALL_DATA_RD,OFFCORE_REQUESTS_OUTSTANDING.DEMAND_RFO,OFFCORE_REQUESTS_OUTSTANDING.DEMAND_DATA_RD:u5,OFFCORE_REQUESTS_OUTSTANDING.DEMAND_DATA_RD"
      ...
      histogram_counters="${lfb_histogram_counters},${sqr_histogram_counters},${sqw_histogram_counters},${sqrw_histogram_counters},OFFCORE_REQUESTS_OUTSTANDING.CYCLES_WITH_DEMAND_DATA_RD,OFFCORE_REQUESTS_OUTSTANDING.DEMAND_DATA_RD:c6"
...
#      topdown_fe_lat_counters="ICACHE.IFETCH_STALL,ITLB_MISSES.STLB_HIT,ITLB_MISSES.WALK_DURATION,RS_EVENTS.EMPTY_END,BR_MISP_RETIRED.ALL_BRANCHES_PS,MACHINE_CLEARS.COUNT,BACLEARS.ANY,DSB2MITE_SWITCHES.PENALTY_CYCLES,ILD_STALL.LCP"
	  ...
	  resource_counters="RESOURCE_STALLS.ANY,RESOURCE_STALLS.RS,RESOURCE_STALLS.OOO_RSRC,RESOURCE_STALLS.LB,RESOURCE_STALLS.SB,RESOURCE_STALLS2.ALL_PRF_CONTROL"
	  ...
	  resource_counters="RESOURCE_STALLS.ANY,RESOURCE_STALLS.RS,RESOURCE_STALLS.LB,RESOURCE_STALLS.SB,RESOURCE_STALLS.ROB,RESOURCE_STALLS2.ALL_PRF_CONTROL,RESOURCE_STALLS2.PHT_FULL,RESOURCE_STALLS.MEM_RS,RESOURCE_STALLS.OOO_RSRC,RESOURCE_STALLS.LB_SB,RESOURCE_STALLS.FPCW_OR_MXCSR,RESOURCE_STALLS.LOAD_MATRIX,RESOURCE_STALLS.OTHER"
	  tlb_counters="DTLB_LOAD_MISSES.MISS_CAUSES_A_WALK,DTLB_LOAD_MISSES.STLB_HIT,DTLB_STORE_MISSES.MISS_CAUSES_A_WALK,DTLB_STORE_MISSES.STLB_HIT"
	  ...
	  *)
      ...
      append_counters $ACTIVATE_HISTORGRAM_COUNTERS "HISTO" ${histogram_counters}

      append_counters $ACTIVATE_LFB_COUNTERS "SuperQ" ${lfb_counters}
