...
then
    ...
    for i in $( seq $META_REPETITIONS )
      ...
      histogram_counters="${lfb_histogram_counters},${sqr_histogram_counters},${sqw_histogram_counters},${sqrw_histogram_counters}"
...
#      topdown_fe_lat_counters="ICACHE.IFETCH_STALL,ITLB_MISSES.STLB_HIT,ITLB_MISSES.WALK_DURATION,RS_EVENTS.EMPTY_END,BR_MISP_RETIRED.ALL_BRANCHES_PS,MACHINE_CLEARS.COUNT,BACLEARS.ANY,DSB2MITE_SWITCHES.PENALTY_CYCLES,ILD_STALL.LCP"
	  ...
	  then
      topdown_mem_counters="CYCLE_ACTIVITY.L1D_PENDING,CYCLE_ACTIVITY.L2_PENDING,MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS,MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS"
      topdown_exe_counters="RS_EVENTS.EMPTY_CYCLES,UOPS_DISPATCHED.THREAD,IDQ_UOPS_NOT_DELIVERED.CYCLES_0_UOPS_DELIV.CORE,CYCLE_ACTIVITY.NO_DISPATCH"
	  else
      ...
      topdown_exe_counters="CYCLE_ACTIVITY.CYCLES_NO_EXECUTE,RS_EVENTS.EMPTY_CYCLES,UOPS_EXECUTED.THREAD,UOPS_EXECUTED.CYCLES_GE_1_UOP_EXEC,UOPS_EXECUTED.CYCLES_GE_2_UOPS_EXEC,UOPS_EXECUTED.CYCLES_GE_3_UOPS_EXEC,UOPS_EXECUTED.CYCLES_GE_4_UOPS_EXEC,IDQ_UOPS_NOT_DELIVERED.CYCLES_0_UOPS_DELIV.CORE,CYCLE_ACTIVITY.NO_DISPATCH"
	  fi
