...
do
	...
	do
		...
		insn_address=$( echo "$group" | cut -f$insn_address_field -d${DELIM} )
		...
		insn_mnemcode=$( echo "$group" | cut -f$insn_mnemcode_field -d${DELIM} )
	...
	stride_status=$( echo "$group" | cut -f$stride_status_field -d${DELIM} )
	...
	stride=$( echo "$group" | cut -f$stride_field -d${DELIM} )
	...
	transferred_bytes=$( echo "$group" | cut -f$transferred_bytes_field -d${DELIM} )
	...
	touched_bytes=$( echo "$group" | cut -f$touched_bytes_field -d${DELIM} )
	...
	overlapped_bytes=$( echo "$group" | cut -f$overlapped_bytes_field -d${DELIM} )
